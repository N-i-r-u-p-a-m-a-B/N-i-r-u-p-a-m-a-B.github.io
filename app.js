// Portfolio JavaScript for Nirupama B
...
class PortfolioApp {
    ...
    updatePageTitle(pageId) {
        const pageTitles = {
            'home': 'Nirupama portfolio',
            'projects': 'Projects - Nirupama portfolio',
            'resume': 'Resume - Nirupama portfolio',
            'contact': 'Contact - Nirupama portfolio'
        };
        
        document.title = pageTitles[pageId] || 'Nirupama portfolio';
    }
    ...
    handleResumeDownload() {
        ...
        this.showNotification('Thank you for your interest! Please contact me directly at bnirupamab@gmail.com to receive the latest version of my resume.', 'info');
        
        // Auto-open email client with pre-filled subject
        setTimeout(() => {
            const emailSubject = encodeURIComponent('Request for Resume - Nirupama B');
            const emailBody = encodeURIComponent('Hello Nirupama,\n\nI would like to request your latest resume.\n\nBest regards,');
            const mailtoLink = `mailto:bnirupamab@gmail.com?subject=${emailSubject}&body=${emailBody}`;
...
document.addEventListener("DOMContentLoaded", function () {
    ...
    if (downloadBtn) {
        downloadBtn.addEventListener("click", function () {
            ...
            link.download = "Nirupama_B_Resume.pdf";
